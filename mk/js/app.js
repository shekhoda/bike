(() => {
  ...
  function F(e) {
    ...
    c && o.target && o.target.shadowRoot && u && (d = y(u[0]));
  ...
  function de({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(a), (e.pagination.bullets = n.find(oe(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((a = t.renderFraction
  ...
  function ce({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function u() {
      e.params.autoplay.disableOnInteraction ? l() : (i("autoplayPause"), o()),
        ["transitionend", "webkitTransitionEnd"].forEach((t) => {
          e.$wrapperEl[0].removeEventListener(t, c);
        });
    }
  ...
  window.addEventListener("load", function (e) {
    pe(),
      document.querySelector(".slider__body") &&
        new ae(".slider__body", {
          modules: [le, de, ce],
